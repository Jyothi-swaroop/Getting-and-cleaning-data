...
3.Merges the training and the test sets to create one data set
 a)xdata (10299 rows, 561 columns) is created by merging x_train and x_test using rbind() function
 
 b)ydata (10299 rows, 1 column) is created by merging y_train and y_test using rbind() function

 c)subject (10299 rows, 1 column) is created by merging subject_train and subject_test using rbind() function

 d)data (10299 rows, 563 column) is created by merging Subject, Y and X using cbind() function
